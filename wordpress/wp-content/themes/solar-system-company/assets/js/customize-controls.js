( function( $ ) {
  var this_obj = solar_system_company_customizer_params;
  ...
  api.bind( 'pane-contents-reflowed', function() {
    ...
    api.section.each( function( section ) {
      ...
      if (
        'solar_system_company_section' !== section.params.type ||
    ...
    api.panel.each( function( panel ) {
      ...
      if (
        'solar_system_company_panel' !== panel.params.type ||
  ...
  wp.customize.Panel = wp.customize.Panel.extend({
    attachEvents: function() {
      ...
      if (
        'solar_system_company_panel' !== this.params.type ||
  ...
  wp.customize.Section = wp.customize.Section.extend({
    attachEvents: function() {
      if (
        'solar_system_company_section' !== this.params.type ||
...
(function (api) {
  ...
  api.Tab = api.Control.extend({
    ready: function () {
      var control = this;
      control.container.find('a.solar-system-company-customizer-tab').click(function (evt) {
        var tab = jQuery(this).data('tab');
        evt.preventDefault();
        control.container.find('a.solar-system-company-customizer-tab').removeClass('active');
  ...
  jQuery.extend(api.controlConstructor, {
    'solar-system-company-tab': api.Tab
  });
