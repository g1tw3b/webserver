...
<div class="card card-outline card-primary">
    ...
    <textarea class="form-control" id="description" name="description" rows="3" placeholder="Enter user description"><?php echo isset($meta['description']) ? $meta['description'] : '' ?></textarea>
</div>
